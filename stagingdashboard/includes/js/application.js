...
//         <p style="padding:5px; margin-left:10px;"><span><b>' + item.Status + '</b></span>';
// 				if (item.StatusId == 1 || item.StatusId == 2 ) {
// CustomCard += '<span id="selected" style="float:right; margin-right:10px;">' + item.TotalRequestItems + '</span></p></div></div></div>';
//         } else {
...
$(document).on("click", ".BulktruckDropDown_list a", function () {
