...
var TruncateMarkup = (_temp2 = _class = function (_React$Component) {
  ...
  TruncateMarkup.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    this.setState({
      ...
      _this3._lineHeight = nextProps.lineHeight || getLineHeight(_this3.el);
  ...
  TruncateMarkup.prototype._tryToFit = function _tryToFit(rootEl, splitDirections) {
    ...
    var ellipsis = typeof this.props.ellipsis === 'function' ? this.props.ellipsis(newRootEl) : _typeof(this.props.ellipsis) === 'object' ? React.cloneElement(this.props.ellipsis, { key: 'ellipsis' }) : this.props.ellipsis;
