...
var TruncateMarkup = (_temp2 = _class = function (_React$Component) {
  ...
  TruncateMarkup.prototype.componentDidMount = function componentDidMount() {
    ...
    this._lineHeight = this.props.lineHeight || __WEBPACK_IMPORTED_MODULE_2_line_height___default()(this.el);
    ...
    this.resizeObserver = new __WEBPACK_IMPORTED_MODULE_3_resize_observer_polyfill__["a" /* default */](function () {
      if (initialRender) {
  ...
  TruncateMarkup.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    this.setState({
      ...
      _this3._lineHeight = nextProps.lineHeight || __WEBPACK_IMPORTED_MODULE_2_line_height___default()(_this3.el);
