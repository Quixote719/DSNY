 ...
 */
	...
	if (SearchDate == "" || SelecteBorough == "" || selectedDistrictID == "") {
		window.location.href = '/assets/dsny/stagingbulkdashboard/login.shtml';
	}
				...
				if (json != undefined) {
                    ...
                    $.each(json, function (key, item) {
									...
									if (SelectedCategoryID == 1) {
										img = '<span><img src="/assets/dsny/stagingbulkdashboard/includes/img/Black-CRT-TV-Icon.svg" alt="TV Icon" style="width:25px;height:20px; padding:0px; margin-right:3px;margin-top:-4px;"></span>';
									}
									else if (SelectedCategoryID == 17){
										img = '<span><img src="/assets/dsny/stagingbulkdashboard/includes/img/black-TV.svg" alt="TV Icon" style="width:20px;height:15px; padding:0px; margin-right:5px;"></span>';
									}
									...
									<div class="dec button addon"><img  src="/assets/dsny/stagingbulkdashboard/includes/img/hover-minus.svg" class="divdecimage"></div>\
										<input type="text" class="txtValue disableText addon" name="tvSubCat'+ addonCategoryID +'" id="'+ item.SubCategoryId +'" maxlength="2" value="0">\
										<div class="inc button addon"><img  src="/assets/dsny/stagingbulkdashboard/includes/img/hover plus.svg" class="divimage" > </div> </div> </div>'
								});
					...
					$.each(json, function (key, item) {
                        ...
                        SubCatStr +=  '<div class="categorycard" id="'+ item.CategoryId + '"  style="line-height:35px;">\
                         ...
                         ctgStr += '<div class="row divborder">\
							...
							<div class="inc button addon"><img  src="/assets/dsny/stagingbulkdashboard/includes/img/hover plus.svg" class="divimage"></div>\
							</div> </div>'
   ...
   CustomCard += '<button type="button" class=" expose btn dropdown dropdown-split truckMenuDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"  style="float:right;background-color:#457cfb; border-radius:5px;margin:2px 5px 0px 0px; padding:0px 3px 0px 3px;height:30px;">\
    ...
    <span class="AssignedTruck" style="margin-bottom:-3px; color:white;">' + item.TruckSerialNo + '</span>\
     ...
     CustomCard += '<div class="card-block completePopup" style="padding:0px 5px 5px 5px"; >\
            ...
            <p class="card-text">\
                <span>\
                   <img src="/assets/dsny/stagingbulkdashboard/includes/img/Black-CRT-TV-Icon.svg" alt="TV Icon" style="width:25px;height:20px; padding:0px; margin-right:3px;margin-top:-4px;">\
                </span>\
                <span>CRT (' + item.CRTTVs + ')</span> &\
                <span><img src="/assets/dsny/stagingbulkdashboard/includes/img/black-TV.svg" alt="TV Icon" style="width:20px;height:15px; padding:0px; margin-right:5px;"></span>\
...
//        });
	   ...
	   $(document).on("change","input:text.txtValue", function() {
						...
						$.each(arr, function (key, item) {
							...
							if (item.PickupRequestSubItems.length > 0) {
								...
								$.each(arrSubCat, function (Subkey, Subitem) {
									...
									<div class="dec button"><img  src="/assets/dsny/stagingbulkdashboard/includes/img/hover-minus.svg" class="divdecimage"></div>\
										...
										<div class="inc button"><img  src="/assets/dsny/stagingbulkdashboard/includes/img/hover plus.svg" class="divimage" > </div> </div> </div>'
							...
							<div class="inc button"><img  src="/assets/dsny/stagingbulkdashboard/includes/img/hover plus.svg" class="divimage"></div>\
							</div> </div>'
		...
		$('#print').click(function () {
			window.location.href = '/assets/dsny/stagingbulkdashboard/printdashboard.shtml';
			return false;
		});
