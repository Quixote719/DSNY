...
$('#EODReport').click(function () {
    window.location.href = '/assets/dsny/dashboard/BulkEODReport.shtml';
    return false;
});

$('#print').click(function () {
    window.location.href = '/assets/dsny/dashboard/RouteReport.shtml';
    return false;
});
...
$("#SR_search_input").keyup(function (event) {
		...
		// $('#EODReport').click(function () {
		// 		window.location.href = '/assets/dsny/dashboard/EODReport.shtml';
		// 		return false;
		// });

		$('#AssReport').click(function () {
				window.location.href = '/assets/dsny/dashboard/AssignReport.shtml';
				return false;
		});
...
$('#BulkPickup').click(function () {
    window.location.href = '/assets/dsny/dashboard/BulkIndex.shtml';
