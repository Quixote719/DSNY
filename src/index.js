        ...
        <div id="headerContent" className="headerContent">
          ...
          <div>
            <Switch>
              ...
              <Route exact="exact" path={process.env.REACT_APP_SITE_RELATIVE_URL + "/:slug"} component={fullImageContainer}/>
              ...
              <Route exact="exact" path={process.env.REACT_APP_SITE_RELATIVE_URL + "/collectionSchedule"} component={CollectionSchedule}/>
