...
export const FETCH_EDUCATIONAL_MATERIALS_FOR_SCHOOL_SUB_LIST_URL = `${ROOT_WORDPRESS_URL}wp_query/args?post_type=card&cat=61&order=ASC&meta_key=rank&orderby=meta_value_num&posts_per_page=5`;
