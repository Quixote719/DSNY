...
const eventParticipationRequestFormElements = (props) => {
  ...
  return (<fieldset className='disabledContactForm' disabled={values.editMode}>
    ...
    <Field component={DateTimePickerInput} name="EndDate" {...props} onChange={setFieldValue}/>
    <Field component={DropdownInput}  name="StartTime" timeField={true} {...props} ondropDownChange={handledropDown} onChange={setFieldValue}  options={values.startDailyTimes} disabled={values.editMode}/>
    <Field component={DropdownInput} name="EndTime" timeField={true} {...props} ondropDownChange={handledropDown} onChange={setFieldValue} options={values.EndDailyTimes} disabled={values.editMode} />
    ...
    <Field component={DropdownInput} name="AttendeeCountRangeId" {...props} ondropDownChange={handledropDown} onChange={setFieldValue} options={values.AttendeeCountRanges} disabled={values.editMode} {...props} />
    ...
    <Field component={TextInput} name="PAddress" {...props} maxlength="50" required/>
    ...
    <Field component={TextInput} name="SOrganization" {...props} maxlength="35" required/>
    <Field component={TextInput} name="SAddress"{...props} maxlength="50" required/>
    <Field component={TextInput} name="SSuite" {...props} maxlength="10" required/>
    ...
    <Field component={TextInput} name="SEmailConfirm" {...props} maxlength="50" required/>
