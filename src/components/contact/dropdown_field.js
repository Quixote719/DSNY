  ...
  render() {
    ...
    <div>
      <Col className='FormField' xs={12} sm={6} md={6}>
        <fieldset>
          <div className='FormMultiSelectTitle'>{this.props.title}{this.props.required ? this.props.hideAsterix ? <span></span>  : <span className="requiredAsterik"> *</span>:<span></span>}</div>
