...
const EwastePickUpRequestFormElements = (props) => {
	...
	return (<fieldset className='disabledContactForm' disabled={values.editMode}>
		...
		<Field component={Nstepper} categories={values.categories} name="ElectronicCategory" header='ELECTRONIC CATEGORY (Maximum of 20 items including no more than 5 TVs per request)' tableHeader='Electronic Category' {...props} required="required" disabled={values.editMode} onChange={setFieldValue}/>
