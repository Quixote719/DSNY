...
import {
  PSOT_LOT_CLEANING_URL, PSOT_LOT_CLEANING_FILE_URL
...
import {Titles, formObject, fileObject as FormObject } from './constants'
...
class LotCleaning extends Component {
  ...
  postFile(fileObject){
    this.props.postFormObject(fileObject, PSOT_LOT_CLEANING_FILE_URL);
  }
  ...
  render() {
    ...
    if (FormObject && FormObject !== undefined) {
      return (<div className='container'><div className='form compostForm'>
              <FormSteps formFields={formFields} geoCoderAddressResult={geoCoderAddressResult} isAddressValidated={isAddressValidated} success={success} customFormData={FormObject} validateForm={this.validateForm} formTitles={Titles} onSubmit={this.postFile}/>
              </div></div>);
    };
