...
const masterComposerCertificateCourseElements = (props) => {
  ...
  return (<fieldset className='disabledContactForm' disabled={values.editMode}>
    ...
    <Field component={TextAreaInput} name="DescribeExperience"  {...props} required/>
    <Field component={TextAreaInput} name="WhyYouWantToBecome"  {...props} required/>
    <Field component={TextAreaInput} name="HowWouldYouUse"  {...props} required/>
    <Field component={TextAreaInput} name="CommunityAffiliations"  {...props} required/>
