...
import {
  POST_FORM_PRVT_RCPTBLE_CMPLNTS_URL
...
class PrivateReceptableComplaintForm extends Component {
  constructor(props) {
    super(props);
  ...
  postForm(formObject){
      this.props.postFormObject(formObject, POST_FORM_PRVT_RCPTBLE_CMPLNTS_URL);
  }
...
export default connect(mapStateToProps, {fetchFormObject, postFormObject})(PrivateReceptableComplaintForm);
