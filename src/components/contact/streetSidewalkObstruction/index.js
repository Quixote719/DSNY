...
import {
  PSOT_FORM_STREET_SIDEWALK_OBSTRUCTION_URL
...
class StreetSidewalkObstruction extends Component {
  constructor(props) {
    super(props);
  ...
  postForm(formObject){
      this.props.postFormObject(formObject, PSOT_FORM_STREET_SIDEWALK_OBSTRUCTION_URL);
  }
  ...
  render() {
    ...
    if(success !== undefined) {
      if(success && success.SRNo){
        return displayThankYouPage( `<div><div class='thankyoulable'>THANK YOU</div><div class='thankyoubody'><p>Your Street/Sidewalk Obstruction Complaint form has been submitted succeffuly.</p><p>&nbsp;</p><p>The Service Request number is</p><p class='SRNumberThankYou'>${success.SRNo}</p><p>Use this number when you check the status of your request.</p><p>&nbsp;</p><p>You will also receive an email with this information. To check the status of this request please visit the DSNY Website Contact page. To reschedule or cancel your request please call 311.</p></div></div>`)        
      }
      else{
...
export default connect(mapStateToProps, {fetchFormObject, postFormObject})(StreetSidewalkObstruction);
