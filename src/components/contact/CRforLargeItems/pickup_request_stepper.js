	...
	renderCatg(ItemCatg) {
		if (ItemCatg)
			return _.map(ItemCatg, Item => {
				...
				return (<div key={Item.Category}><FormStepper obj={Item} total='99'  maxValue='99' disabled={this.props.disabled} title={Item.Category} onIncDec={this.updateState} header={subCatg}/></div>);
			});
		}
