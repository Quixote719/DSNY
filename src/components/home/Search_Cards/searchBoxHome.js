...
class SearchBoxHome extends Component {
  ...
  getSuggestions = value => {
    ...
    return inputLength === 0
      ? []
      : this.props.ridOffKeywords.filter(lang => lang.toLowerCase().slice(0, inputLength) === inputValue);
  };
