(function ($) {
	...
	$.fn.shareButtons = function (url, options) {
		...
		this.each(function(i){
			...
			if(options.twitter){
				socialButtonsPopUp.append($('<a class="fa fa-twitter" href="#" ><span class="twitter_custom"></span></a></a>'));
			}

			if(options.facebook){
				socialButtonsPopUp.append($('<a class="fa fa-facebook" href="#" ><span class="facebook_custom"></span></a>'));
			}

			if(options.googlePlus){
				socialButtonsPopUp.append($('<a class="fa fa-google-plus" href="#" ><span class="googleplus_custom"></span></a>'));
			}

			if(options.pinterest) {
				socialButtonsPopUp.append($('<a class="fa fa-pinterest" href="#" ><span class="facebook_custom"></span></a>'));
			}

			if(options.tumblr) {
				socialButtonsPopUp.append($('<a class="fa fa-tumblr" href="#" ><span class="tumblr_custom"></span></a>'));
			}

			if(options.contactmail) {
				socialButtonsPopUp.append($('<a class="fa fa-envelope-o" href="#" ><span class="email_custom"></span></a>'));
			}
		...
		$('.socialPlugin a').click(function(e) {
			...
			if($(this).attr('class') != "fa fa-envelope-o")
			{
				e.preventDefault();
